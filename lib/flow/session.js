...
class Session extends EventEmitter {
    ...
    constructor(name, conflictResolutionStrategy) {
        ...
        this.agenda.on('fire', this.emit.bind(this, 'fire'));
        this.agenda.on('focused', this.emit.bind(this, 'focused'));
        this.rootNode = new nodes.RootNode(this.workingMemory, this.agenda);
        _.bindAll(this, ['halt', 'assert', 'retract', 'modify', 'focus',
    ...
    /**
     * Assert a fact into the current session.
     * @param fact
     * @return {*}
     */
    assert(fact) {
