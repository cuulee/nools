...
const HashConstraint = constraints.HashConstraint;
const ReferenceConstraint = constraints.ReferenceConstraint;
...
class RootNode {
    ...
    __createJoinNode(rule, pattern, outNode, side) {
        ...
        if (pattern.rightPattern instanceof NotPattern) {
            ...
            && !hasRefernceConstraints(pattern.leftPattern)
            && !hasRefernceConstraints(pattern.rightPattern)) {
