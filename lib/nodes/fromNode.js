...
const EqualityConstraint = constraint.EqualityConstraint;
const HashConstraint = constraint.HashConstraint;
const ReferenceConstraint = constraint.ReferenceConstraint;
...
class FromNode extends JoinNode {
    ...
    constructor(pattern, wm) {
        ...
        const eqConstraints = [];
        let vars = [];
        forEach(this.constraints = this.pattern.get('constraints').slice(1), (c) => {
